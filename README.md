...
4. เข้าไปที่แท็บ **Variables** ของโปรเจกต์ แล้วเพิ่มตัวแปรตามนี้:
   ...
   | `ANTHROPIC_API_KEY` | API key ของ Anthropic (สมัคร/สร้างได้ที่ [console.anthropic.com](https://console.anthropic.com/settings/keys)) — ใช้กับฟีเจอร์ "AI สแกนเอกสาร" และ "สรุปโครงการอัตโนมัติ" ในตัวแอป ถ้าไม่ตั้งค่านี้ 2 ฟีเจอร์นี้จะใช้ไม่ได้ แต่ส่วนอื่นของแอปยังใช้งานได้ปกติ |
